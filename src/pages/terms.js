  ...
  <Layout title="Terms of service">
    <section className={pageClasses}>
      <div className={styles.page__heading}>
        ...
        <p className={styles.heading__underlined}>Updated May 1st, 2020</p>
      </div>
      ...
      <div className={[styles.page__content, styles.page__contentLeftAligned].join(' ')}>
        ...
        <ul>
          ...
          <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>  <li><strong>Company</strong> (referred to as either &ldquo;the Company&rdquo;, &ldquo;We&rdquo;, &ldquo;Us&rdquo; or &ldquo;Our&rdquo; in this Agreement) refers to Bonkey Bong LLC, 5100 SE 78th St Portland, OR 97206.</li>
          <li><strong>Content</strong> refers to content such as text, images, or other information that can be posted, uploaded, linked to or otherwise made available by You, regardless of the form of that content.</li>  <li><strong>Country</strong> refers to: Oregon, United States</li>
          <li><strong>Device</strong> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</li>
          <li><strong>Service</strong> refers to the Website.</li>
          <li><strong>Subscriptions</strong> refer to the services or access to the Service offered on a subscription basis by the Company to You.</li>  <li><strong>Free Trial</strong> refers to a limited period of time that may be free when purchasing a Subscription.</li>  <li><strong>Terms and Conditions</strong> (also referred as &ldquo;Terms&rdquo;) mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service.</li>
          <li><strong>Third-party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</li>
          <li><strong>Website</strong> refers to Portway, accessible from <a href="https://portway.app">https://portway.app</a></li>  <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
        </ul>
        ...
        <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at support@portway.app and include in Your notice a detailed description of the alleged infringement.</p>
        ...
        <p>You can contact our copyright agent via email at support@portway.app.</p>
        ...
        <h1>&ldquo;AS IS&rdquo; and &ldquo;AS AVAILABLE&rdquo; Disclaimer</h1>
        ...
        <p>If You are a U.S. federal government end user, our Service is a &ldquo;Commercial Item&rdquo; as that term is defined at 48 C.F.R. §2.101.</p>
        ...
        <ul>
          <li>By email: <a href="mailto:support@portway.app">support@portway.app</a></li>
          <li>By visiting this page on our website: <a href="https://getportway.com/support">https://getportway.com/support</a></li>
        </ul>
