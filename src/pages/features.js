          ...
          <section className="features__tabs">
            <TabList onChange={tabChangeHandler}>
              ...
              <Tab className="features__tab features__tab--developers" href="#developers" id="tab3" label="Developers">
                <svg height="60" viewBox="0 0 60 60" width="60" xmlns="http://www.w3.org/2000/svg"><path d="m32.2680534 17 1.4772136.260461-4.862 27.575-1.4772136-.260461zm6.3532369 5.3868004 8.53033 8.5303301-8.53033 8.5303301-1.0606602-1.0606602 7.4692301-7.4695699-7.4692301-7.4697699zm-16.0909602 0 1.0606602 1.0606602-7.4691301 7.4697699 7.4691301 7.4695699-1.0606602 1.0606602-8.5303301-8.5303301z" fill="#ea6e42" fillRule="evenodd"/></svg>
              </Tab>
              ...
              <Tab className="features__tab features__tab--outline" href="#outline" id="tab5" label="Document Outline" >
                <svg height="60" viewBox="0 0 60 60" width="60" xmlns="http://www.w3.org/2000/svg"><path d="m34.0606602 13 10.4393398 10.4393398v23.0606602h-27.5v-33.5zm-1.0606602 1.5h-14.5008v30.5h24.5l-.0002-20.501-9.999.0009zm-10.2354 21.7499c.829 0 1.5.672 1.5 1.5s-.671 1.5-1.5 1.5c-.828 0-1.5-.672-1.5-1.5s.672-1.5 1.5-1.5zm16.7354.75v1.5h-13.5v-1.5zm-16.7354-7.75c.829 0 1.5.672 1.5 1.5s-.671 1.5-1.5 1.5c-.828 0-1.5-.672-1.5-1.5s.672-1.5 1.5-1.5zm16.7354.75v1.5h-13.5v-1.5zm-16.7354-7.75c.829 0 1.5.672 1.5 1.5s-.671 1.5-1.5 1.5c-.828 0-1.5-.672-1.5-1.5s.672-1.5 1.5-1.5zm6.7354.75v1.5h-3.5v-1.5zm5-7.4389-.0008 7.438h7.4388z" fill="#ea6e42" fillRule="evenodd"/></svg>
              </Tab>
